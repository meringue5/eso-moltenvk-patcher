...
| 0049 | 2026-08-27 | Metal argument-buffer performance candidate | Installed; descriptor encoding improved 14.899%, both 24-cycle reset probes passed, and user rendering gate is pending | [Run](0049-metal-argument-buffer-performance.md) |
