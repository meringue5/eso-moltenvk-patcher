...
| 0028 | 2026-08-01 / 2026-08-02 | Bounded startup draw-input provenance audit | Succeeded; stable sets/layout/push but descriptor update changed from magenta to scene, rollback waits for Steam exit | [Run](0028-startup-input-provenance.md) |
