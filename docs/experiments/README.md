...
| 0030 | 2026-08-02 | Bounded startup compositor placeholder neutralization | Planned; exact fail-open source candidate and agent-only gates pass, production profile unchanged | [Run](0030-startup-compositor-placeholder-neutralization.md) |
