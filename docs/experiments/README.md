...
| 0037 | 2026-08-17 | Serialized startup pipeline compilation | Running; default compilation policy and bounded direct pipeline timing passed source gates | [Run](0037-serialized-startup-pipeline-compilation.md) |
