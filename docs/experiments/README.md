...
| 0044 | 2026-08-27 | Fixed-window compositor neutralization with pacing bypass | Candidate installed with caches/settings preserved; user launch pending | [Run](0044-compositor-neutralize-pacing-bypass.md) |
