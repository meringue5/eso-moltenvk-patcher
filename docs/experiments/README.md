...
| 0030 | 2026-08-02 | Bounded startup compositor placeholder neutralization | Running; candidate installed with settings/caches preserved, bounded user startup pending | [Run](0030-startup-compositor-placeholder-neutralization.md) |
