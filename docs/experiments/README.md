...
| 0043 | 2026-08-27 | Bounded compositor audit log visibility | Candidate installed with caches/settings preserved; user launch pending | [Run](0043-bounded-audit-log-visibility.md) |
