...
| 0038 | 2026-08-25 / 2026-08-27 | No-neutralizer startup control | First launch normal; later low-FPS recurrence falsified it as a reliability repair | [Run](0038-no-neutralizer-startup-control.md) |
...
| 0049 | 2026-08-27 | Metal argument-buffer performance candidate | Rejected; three consecutive starts missed initial mouse capture despite OS-level focus, rollback pending launcher exit | [Run](0049-metal-argument-buffer-performance.md) |
